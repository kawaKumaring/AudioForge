...
> **상태 (2026-09-03)** — 2026-08-23 조사 기록이며 그대로 보존한다. 「공통 설계 원칙」 다섯 개는
> **현재도 유효하며 v1.4 UI 규칙의 직접 근거**다. 특히 원칙 1(화자와 연기는 다른 축),
> 원칙 2(감정 제어력 비교에는 같은 대사), 원칙 5(수치를 감정 정답으로 표시하지 않는다)를
> 그대로 따른다. 적용 현황은 [감정 음향 전략](../work-in-progress/tts-emotion-acoustic-strategy.md) §3.6·§8.
