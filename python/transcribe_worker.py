...
import os
from audio_utils import emit, fmt_srt_time
...
def transcribe_file(audio_path, output_dir, whisper_model_name="large-v3",
    ...
    """Transcribe a single file. Returns dict with text, language, paths."""
    import whisper
    import torch
    ...
    with open(ts_path, "w", encoding="utf-8") as f:
        for seg in result["segments"]:
            ...
            from audio_utils import fmt_time
            f.write(f"[{fmt_time(s)} → {fmt_time(e)}] {txt}\n")
